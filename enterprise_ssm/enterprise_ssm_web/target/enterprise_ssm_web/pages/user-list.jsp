							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/user/findAll.do?page=1&size=4'">
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/deleteUser.do?uid=${user.uid}" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
